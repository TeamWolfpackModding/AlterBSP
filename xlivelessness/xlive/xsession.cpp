...
// #5317
DWORD WINAPI XSessionWriteStats(DWORD, DWORD, DWORD, DWORD, DWORD, PXOVERLAPPED pXOverlapped)
{
	TRACE_FX();
...
// #5328
DWORD WINAPI XSessionGetDetails(DWORD, DWORD, DWORD, DWORD, DWORD, PXOVERLAPPED pXOverlapped)
{
	TRACE_FX();
